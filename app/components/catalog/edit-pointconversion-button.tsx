...
export default function UpdatePointsModal({ itemId, pointConversion }: PointConversionProps) {
  ...
  >
    ...
    >
      <h2 className="text-lg font-semibold mb-4">Update Point Conversion</h2>
